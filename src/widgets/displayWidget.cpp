...
void DisplayWidget::initializeGL() {
    ...
    shaderProgram->addShaderFromSourceFile(QOpenGLShader::Vertex, "resources\\shaders\\vertexShader.glsl");
    shaderProgram->addShaderFromSourceFile(QOpenGLShader::Fragment, "resources\\shaders\\fragmentShader.glsl");
    shaderProgram->link();
    ...
    skyBoxShaderProgram->addShaderFromSourceFile(QOpenGLShader::Vertex, "resources\\shaders\\skyBoxVertexShader.glsl");
    skyBoxShaderProgram->addShaderFromSourceFile(QOpenGLShader::Fragment, "resources\\shaders\\skyBoxFragmentShader.glsl");
